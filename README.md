About gds-frameio-base-feedstock
================================
...
Installing gds-frameio-base
===========================

Installing `gds-frameio-base` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:
...
Updating gds-frameio-base-feedstock
===================================

If you would like to improve the gds-frameio-base recipe or build a new
...
Note that all branches in the conda-forge/gds-frameio-base-feedstock are
